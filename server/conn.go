...
func NewCustomizedConn(conn net.Conn, serverConf *Server, authHandler AuthHandler, h Handler) (*Conn, error) {
...
func (s *Server) NewConn(conn net.Conn, user string, password string, h Handler) (*Conn, error) {
	authHandler := NewInMemoryAuthHandler()
...
func (s *Server) NewCustomizedConn(conn net.Conn, authHandler AuthHandler, h Handler) (*Conn, error) {
